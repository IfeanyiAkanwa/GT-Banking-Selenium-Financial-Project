...
public class AirtelAirtimeDataTopUp extends TestBase {

	@Test
	public static void navigateToAirtelAirtimeDataTopUpTest() throws InterruptedException {
		WebDriverWait wait = new WebDriverWait(getDriver(), 60);
		
		AirtimeDataTopup.navigateToAirtimeDataTopupTest();

		// Click on Airtel Airtime/Data Topup
		TestUtils.testTitle("Click on Airtel Airtime/Data Topup");
		...
		Thread.sleep(500);
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//a[contains(text(),'Airtel Airtime')]")));
		TestUtils.assertSearchText("XPATH", "//a[contains(text(),'Airtel Airtime')]", "Airtel Airtime");
		TestUtils.assertSearchText("XPATH", "//gtibank-pageheader/div/div/div/p", "Buy Airtel Airtime or Data");
		Thread.sleep(500);
	...
	@Parameters ("testEnv")
	@Test
	public void airtelValidationTest(String testEnv) throws InterruptedException, Exception {
		WebDriverWait wait = new WebDriverWait(getDriver(), 60);
		...
		TestUtils.testTitle("Navigate back to Airtel Airtime view");
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//mat-grid-tile[2]/figure/mat-card")));
		getDriver().findElement(By.xpath("//mat-grid-tile[2]/figure/mat-card")).click();
		Thread.sleep(500);
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//a[contains(text(),'Airtel Airtime')]")));
		...
		// Rater test
		TestUtils.raterTest("Airtel Airtime/Data Topup");
	}
