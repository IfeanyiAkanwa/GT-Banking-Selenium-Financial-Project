...
public class CustomerProfile extends SelfService {
	...
	public void CustomerProfileFieldsCheck() throws InterruptedException {
		...
		getDriver().findElement(By.xpath("//mat-grid-tile[1]")).click();
		Thread.sleep(1000);
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[1]/h2/a")));
		TestUtils.assertSearchText("XPATH", "//div[1]/h2/a", "View Profile");
